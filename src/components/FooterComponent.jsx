...
const FooterComponent = () => {
  return (
    <footer className="bg-gradient-to-br from-purple-900 via-black via-45% to-purple-950 text-white py-10">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start lg:space-x-16">
          ...
          <div className="flex flex-col items-center lg:items-start mb-6 lg:mb-0">
            <h1 className="text-3xl font-bold font-sans">Swatify</h1>
          ...
          <div className="flex flex-col lg:flex-row space-x-0 lg:space-x-10 mb-6 lg:mb-0">
            <div>
              <h3 className="font-semibold py-3">Customer Support</h3>
            ...
            <div>
              <h3 className="font-semibold py-3">Corporate Info</h3>
            ...
            <div>
              <h3 className="font-semibold py-3">Promotion</h3>
              <ul className="space-y-1">
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h3 className="font-semibold">Need Any help?</h3>
            <button className="mt-2 shadow-md shadow-gray-400/50 bg-gradient-to-tr from-purple-950 to-pink-500 text-white py-2 px-4 rounded-full">
              Contact Swatify
            </button>
          </div>
        </div>
